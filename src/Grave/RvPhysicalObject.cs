/*
Removed 06/06/2021 during rewrite of sprites and objects
*/
...
//     public RvPhysicalObject(Vector2 position, Vector2 velocity, RvSprite sprite, float mass, bool immovable, RvAbstractShape hitBox = null) : base(position, hitBox)
//     {
...
//     public void setSprite(RvSprite sprite)
//     {
//         this.sprite = sprite;
//     }
//     public RvSprite getSprite()
//     {
//         return sprite;
//     }
...
//     [JsonProperty] public RvSpriteWrapper spriteWrapper;

//     [JsonProperty] public bool immovable = false;

//     public RvPhysicalObjectWrapper(Vector2 position, Vector2 velocity, RvSpriteWrapper spriteWrapper, float mass, bool immovable, RvAbstractShapeWrapper hitBox) : base(position, velocity, hitBox)
//     {
//         this.mass = mass;
...
//     {
//         RvSprite sprite = spriteWrapper.unWrap();
